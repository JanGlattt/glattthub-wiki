...
| `watch-screens` | `*/5 * * * *` | `/api/cron/watch-screens` | 120 s | Apple-TV-App: Bildschirme überwachen — offline, wieder online, Abweichung vom Plan (`screens:watch`). **Job noch anzulegen** (25.09.2026) |
