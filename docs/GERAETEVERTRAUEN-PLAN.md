...
| 5 | **Prüfer-Konto** mit Token, wenigen Rechten und Testdaten; nach der Prüfung widerrufen | Custom-App-Prüfung möglich | 0,5 Tage | **umgesetzt 23.09.2026** (`app:review-account`), erste Einreichung 1.1.0 (15) am 25.09.2026 **abgelehnt**: Apple prüft mit mehreren Geräten, der Einmal-Code trug nur eins, und die App blieb in der Attestierung hängen — seitdem Mehrfach-Code (`--issue-code`), Zeitlimit und Nachholen der Attestierung; siehe [APP-GERAETE-FREISCHALTUNG.md](APP-GERAETE-FREISCHALTUNG.md#schritt-3-app-attest--das-gerät-beweist-dass-es-echt-ist) |
