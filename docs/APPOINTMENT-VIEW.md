...
- **Zweite Unterschrift per Link (Mitunterzeichner):** Bekommt die zweite Person (z.B. der andere Elternteil) ihren Teil per E-Mail, trägt die Kachel **„1 von 2 Unterschriften"** und „Wartet auf die zweite Unterschrift per Link"; die Pflicht gilt erst als erfüllt, wenn sie unterschrieben hat. Ein Tipp auf die Kachel öffnet ein Modal mit Empfängerin, Datum, Link zu den bisherigen Angaben und **„Link erneut senden"**.
