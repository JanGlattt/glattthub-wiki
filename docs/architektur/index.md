...
- :material-lock: **Sicherheit & Rechte**
    ...
    Spatie-Permissions ohne Rollennamen im Code, zeilenscharfe Datensichtbarkeit, PIN-Login, Session-Ablauf mit Sitzungsschutz.

    [:octicons-arrow-right-24: Berechtigungssystem](../BERECHTIGUNGSSYSTEM.md) · [Datensichtbarkeit](../DATA-VISIBILITY.md) · [Session](../SESSION-ABLAUF.md)
