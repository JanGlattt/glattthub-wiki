...
# Diese Serie fotografiert Geld. Der Lauf **liest nur**: Fenster werden geöffnet und mit Escape verworfen. Ausdrücklich NIE gedrückt: „Betrag per SEPA e
#
...
for v in KLICK_BASE KLICK_USER KLICK_PW KLICK_CONTRACT KLICK_SEARCH; do
