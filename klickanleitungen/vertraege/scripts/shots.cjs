...
const PLAN = [
  ...
  { name: 'vt5-einziehen', url: '/hub/contracts/' + L.CONTRACT, oeffne: 'Betrag einziehen', verwerfen: true },
  { name: 'vt5-anhaengen', url: '/hub/contracts/' + L.CONTRACT, oeffne: 'RLS anhängen', verwerfen: true },
  ...
  { name: 'vt6-raten-anpassen', url: '/hub/contracts/' + L.CONTRACT, oeffne: 'Raten anpassen', verwerfen: true },
  { name: 'vt6-laufzeit', url: '/hub/contracts/' + L.CONTRACT, oeffne: 'Raten anpassen', verwerfen: true },
  { name: 'vt6-pausieren', url: '/hub/contracts/' + L.CONTRACT, oeffne: 'Pausieren', verwerfen: true },
  { name: 'vt6-fortsetzen', url: '/hub/contracts/' + L.CONTRACT, oeffne: 'Fortsetzen', verwerfen: true },
