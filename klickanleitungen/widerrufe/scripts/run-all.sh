...
# Der Lauf **legt keinen Widerruf an und schliesst keinen ab**. Der Assistent wird durchgeklickt und abgebrochen. NIE gedrückt: „Widerruf erfassen", „Ab
#
...
for v in KLICK_BASE KLICK_USER KLICK_PW KLICK_CANCELLATION KLICK_CONTRACT; do
